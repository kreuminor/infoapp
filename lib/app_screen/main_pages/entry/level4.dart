        ...
        new Container(
          child: SingleChildScrollView(
            child: Html(
              data: """
           <hr />
           <b>SPECIALIZED or SUPERVISORY WORKER</b>
           <hr/>
           <br><b>Qualification Offered</b><br>
           <ul><li>CVQ/NVQ-J Level 4 Award or Associate Degree</li></ul>
                        ...
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
                              alignment: Alignment(0.0, 0.0),
                              child: new Text("4 Subjects with 2 "),),],)),
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
                        ...
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
                              alignment: Alignment(0.0, 0.0),
                              child: new Text("subjects in related"),),],)),
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
                        ...
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
                              alignment: Alignment(0.0, 0.0),
                              child: new Text("Mastery, Comptent"),),],)),
                      ]),
                  //--Row 6
                  TableRow(
                      children: [
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
                              alignment: Alignment(0.0, 0.0),
                              child: new Text("5 Subjects including"),),],)),
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
                        ...
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
                              alignment: Alignment(0.0, 0.0),
                              child: new Text("CVQ/NVQ-J Level 3"),),],)),
                        TableCell(child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            new Container(
                              height: 25.0,
