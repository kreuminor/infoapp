...
import 'package:heartinfo/app_screen/main_pages/apply/login/dummy/triangle_painter.dart';


class NDARPage extends StatelessWidget {
  @override
          ...
          Padding(
            ...
            child: Align(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Image.asset("images/ndarlogo.png",
                    color: Colors.white,
                    width: 230.0,
                    height: 130.0,
                  ),
                  Padding(
                    ...
                    child: Text(
                      "THE NATIONAL DIAGNOSTIC ASSESSMENT AND REFERRAL SYSTEM",
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 12.0,
