...
class YouthLPage extends StatefulWidget {
  @override
  YouthLPageState createState() => new YouthLPageState();
}

class YouthLPageState extends State<YouthLPage> {
  ...
  Future<String> getData() async {
    var response = await DefaultAssetBundle
        .of(context).loadString('local_json/offerings/youth.json');
