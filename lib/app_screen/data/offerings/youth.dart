...
class YouthPage extends StatefulWidget {
  @override
  _YouthPageState createState() => new _YouthPageState();
}

class _YouthPageState extends State<YouthPage> {
  ...
  Widget build(BuildContext context) {
    return new Theme (
        ...
        child:Scaffold(
          appBar: new AppBar(
            title: new Text('Youth Programme'),
            actions: <Widget>[
                  ...
                  itemBuilder: (context, i) {
                    return new Card(
                      child: new Column(
                        ...
                        children: <Widget>[
                          new Text(_searchResult[i].Programme_Name, style: TextStyle(color: Colors.red, fontSize: 15.0),),
                          ...
                          new Text("Address : "+_searchResult[i].Address, style: TextStyle(fontSize: 15.0),),
                          Divider(height: 3.0, color: Colors.white,),
                  ...
                  itemBuilder: (context, index) {
                    return new Card(
                      child: new Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          new Text(_offerings[index].Programme_Name, style: TextStyle(color: Colors.red, fontSize: 15.0),),
                          Divider(height: 5.0, color: Colors.white,),
...
final String url = 'https://tms.heart-nta.org/htawebservice/getPrograminfo.asmx/Get_nys_info';

class Offerings {
  //final int id;
  final String Programme_Name, Institution_Name, Address, Start_Date, End_Date;

  Offerings({this.Institution_Name, this.Programme_Name, this.Address, this.Start_Date, this.End_Date});
