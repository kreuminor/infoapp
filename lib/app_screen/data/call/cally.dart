...
class CallyPage extends StatefulWidget {
  @override
  CallyPageState createState() => new CallyPageState();
}

class CallyPageState extends State<CallyPage> {
    ...
    this.setState(() {
     ...
     // print(data[0]["InstitutionType"]);
      ...
      for (Map data in extractdata["Result"]) {
        ...
        if (data['InstitutionType']== "Youth Services" )
...
class Dialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new AlertDialog(
      title: Text("Youth Centres", style: TextStyle(color: Colors.red, fontSize: 15.0),),
      content: new Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text("Do you want to make a call to "+ offer.Institution+" Youth Centre " + ", at "  + offer.Telephone+ "?. If yes, click "
