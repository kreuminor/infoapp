...
class CallEPage extends StatefulWidget {
  @override
  CallEPageState createState() => new CallEPageState();
}

class CallEPageState extends State<CallEPage> {
    ...
    this.setState(() {
     ...
     // print(data[0]["InstitutionType"]);
      ...
      for (Map data in extractdata["Result"]) {
        ...
        if (data['InstitutionType']== "Engagment Centre" )
...
class Dialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new AlertDialog(
      title: Text("Engagement Centre", style: TextStyle(color: Colors.red, fontSize: 15.0),),
      content: new Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text("Do you want to make a call to an Engagement Centre "+ offer.Institution + ", to " + offer.Telephone+ "?. If yes, click "
