...
class CallhPage extends StatefulWidget {
  @override
  CallhPageState createState() => new CallhPageState();
}

class CallhPageState extends State<CallhPage> {
    ...
    this.setState(() {
     ...
     // print(data[0]["InstitutionType"]);
      ...
      for (Map data in extractdata["Result"]) {
        ...
        if (data['InstitutionType']== "TVET Institute" )
...
class Dialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new AlertDialog(
      title: Text("HEART Institutions", style: TextStyle(color: Colors.red, fontSize: 15.0),),
      content: new Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text("Do you want to make a call to " + offer.Institution + ", at " + offer.Telephone+ "?. If yes, click "
