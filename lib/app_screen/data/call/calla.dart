...
class CallAPage extends StatefulWidget {
  @override
  CallAPageState createState() => new CallAPageState();
}

class CallAPageState extends State<CallAPage> {
    ...
    this.setState(() {
     ...
     // print(data[0]["InstitutionType"]);
      ...
      for (Map data in extractdata["Result"]) {
        ...
        if (data['InstitutionType']== "Adult Education" )
...
class Dialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new AlertDialog(
      title: Text("Adult Centre", style: TextStyle(color: Colors.red, fontSize: 15.0),),
      content: new Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text("Do you want to make a call to a " + offer.Institution + " Adult Centre " +", at "+ offer.Telephone+ "?. If yes, click "
